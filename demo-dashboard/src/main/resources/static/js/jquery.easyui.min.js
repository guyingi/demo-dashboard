...
_234.find("div.panel-util .panel-util-a").appendTo(opts.tools);
}
_234.empty();
...
var tool=$("<div class=\"panel-util\"></div>").appendTo(_234);
...
$(this).addClass($(this).attr("iconCls")).addClass("panel-util-a").appendTo(tool);
});
}
}
if(opts.collapsible){
_236(tool,"panel-util-collapse",function(){
...
if(opts.minimizable){
_236(tool,"panel-util-min",function(){
_25d(_22d);
});
}
if(opts.maximizable){
_236(tool,"panel-util-max",function(){
...
if(opts.closable){
_236(tool,"panel-util-close",function(){
_249(_22d);
});
}
}
...
var tool=_246.children(".panel-header").find("a.panel-util-restore");
if(tool.length){
opts.maximized=true;
}
...
var tool=_256.find("a.panel-util-collapse");
if(opts.collapsed==true){
return;
}
body.stop(true,true);
...
tool.addClass("panel-util-expand");
if(_254==true){
if(opts.halign=="left"||opts.halign=="right"){
...
var tool=_25a.children(".panel-header").find("a.panel-util-collapse");
...
tool.removeClass("panel-util-expand");
if(_259==true){
if(opts.halign=="left"||opts.halign=="right"){
body.show();
...
var tool=_25c.children(".panel-header").find("a.panel-util-max");
if(opts.maximized==true){
return;
}
tool.addClass("panel-util-restore");
...
var tool=_262.children(".panel-header").find("a.panel-util-max");
if(opts.maximized==false){
return;
}
_262.show();
tool.removeClass("panel-util-restore");
...
if(btn=="-"){
$("<td><div class=\"dialog-util-separator\"></div></td>").appendTo(tr);
}else{
var td=$("<td></td>").appendTo(tr);
...
var tool=_2fc.children("div.panel-util");
tool.children("a.panel-util-collapse").hide();
...
var tool=_332.children("div.tabs-util:not(.tabs-util-hidden)");
...
_33a.children("div.tabs-util").remove();
var _33b=$("<div class=\"tabs-util\"><table cellspacing=\"0\" cellpadding=\"0\" style=\"height:100%\"><tr></tr></table></div>").appendTo(_33a);
var tr=_33b.find("tr");
...
_340.children("div.tabs-scroller-left,div.tabs-scroller-right,div.tabs-util:not(.tabs-util-hidden)").css("display",opts.showHeader?"block":"none");
...
var _342=_340.width()-_340.children(".tabs-util:not(.tabs-util-hidden)")._outerWidth();
...
if(opts.tools){
var _376=tab.find("span.tabs-p-util");
if(!_376.length){
var _376=$("<span class=\"tabs-p-util\"></span>").insertAfter(tab.find("a.tabs-inner"));
}
if($.isArray(opts.tools)){
_376.empty();
for(var i=0;i<opts.tools.length;i++){
...
tab.find("span.tabs-p-util").remove();
...
var tool=$(_398).find(">.tabs-header>.tabs-util");
if(_399){
tool.removeClass("tabs-util-hidden").show();
}else{
tool.addClass("tabs-util-hidden").hide();
}
...
var tool=$(this).panel("header").children("div.panel-util");
tool.children("a.panel-util-collapse").hide();
